...
-   **Агрегація загроз**: Поєднує дані локальних приманок із зовнішніми джерелами OSINT.
-   **Висока продуктивність**: Працює на Redis для часу відгуку менше мілісекунди.
...
-   **Сучасний інтерфейс**: Панель керування в темній темі для управління списками, API ключами та перегляду статистики.
...
-   **База даних**: Redis
-   **Фронтенд**: Шаблони Jinja2, Bootstrap 5 (Темний режим)
-   **Розгортання**: Docker
