...
### Querying Reputation [🔗](#querying-reputation)
...
### 1. Reputation Check (ThreatBook v3 Compatible) [🔗](#1-reputation-check-threatbook-v3-compatible)
...
### 2. Webhook (HFish Compatible) [🔗](#2-webhook-hfish-compatible)
